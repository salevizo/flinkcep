...
public class SuspiciousPackage {
    ...
    public SuspiciousPackage(Integer mmsi_1, Integer mmsi_2, float lon1, float lat1, float lon2, float lat2, Integer timestamp) {
        this.mmsi_1 = mmsi_1;
        this.mmsi_2 = mmsi_2;
        this.lon1 = lon1;
        this.lat1 = lat1;
    ...
    public String getSuspiciousPackage(){

        return "Package Picking Vessels:Vessel_1:"+mmsi_1+" Longitude_1:"+lon1+" Latitude_1:"+lat1+" Vessel_2:"+mmsi_2 + "Longitude_2:"+lon2+" Latitude_2:"+lat2+ "Time:"+timestamp;
    }
}
